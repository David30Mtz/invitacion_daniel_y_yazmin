...
const moments = [
  {
    ...
    text: "Aquí fue nuestra primera fotografía juntos como novios, sabiendo que con el paso del tiempo me iba a enamorar con una gran locura de mi maravillosa novia. Ahora daremos un gran paso en nuestras vidas.",
